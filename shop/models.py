...
class Product(models.Model):
    ...
    image = models.ImageField(upload_to=getFilename)
    image1 =models.ImageField(upload_to=getFilename, null=True)
    image2 = models.ImageField(upload_to=getFilename, null=True)
    ...
    demo_url = models.URLField(null=True)
    recommandation = models.TextField(null=True)
    benifits_and_features = models.TextField(null=True)
